...
import { addParticipant } from "../controllers/tasks.controller.js";
import { removeParticipant } from "../controllers/tasks.controller.js";
...
router.post("/:taskId/participants", auth, addParticipant);
router.delete("/:taskId/participants/:userId", auth, removeParticipant);
